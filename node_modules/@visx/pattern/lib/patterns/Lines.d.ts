...
export default function Lines({ id, width, height, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, orientation, background, className, }: PatternLinesProps): import("react/jsx-runtime").JSX.Element;
