...
import { c as U, d as j, e as S, S as T, b as L, p as M, f as P, w as N, g as $, o as w } from "./ssr-DvIINv8w.mjs";
...
const p = (n, t, e) => {
  ...
  C && typeof HTMLElement < "u" && typeof customElements < "u" && !customElements.get(n) && customElements.define(n, t);
};
...
class D extends T {
  ...
  set data(t) {
    ...
    if (this.created) {
      const c = this._data;
      this._data = t, this.computedTrend = typeof this.trend == "function" ? this.trend(c.value, a) : this.trend, this.computedAnimated = B && this._animated && (!this.respectMotionPreference || !((r = M) != null && r.matches)) && // https://github.com/barvian/number-flow/issues/9
      ...
      this.nonce && (c.nonce = this.nonce), c.textContent = L, this.shadowRoot.appendChild(c), this._pre = new E(this, e, {
        justify: "right",
        part: "left"
